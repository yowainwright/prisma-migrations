...
This creates `migration.sql` and `down.sql` inside the initial migration directory.

## Step 5: Write the Initial Migration - Users Table
...
Put the forward change in the new `migration.sql`:
...
You should see the initial users migration and the posts migration.
