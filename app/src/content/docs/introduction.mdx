...
<div className="flex flex-wrap gap-2 mb-8">
  <a
    href="https://badge.fury.io/js/prisma-migrations"
    target="_blank"
    rel="noopener noreferrer"
  >
    <img
      src="https://badge.fury.io/js/prisma-migrations.svg"
      alt="npm version"
    />
  </a>
  <a
  ...
  >
    <img
      src="https://img.shields.io/github/stars/yowainwright/prisma-migrations?style=social"
      alt="GitHub stars"
    />
  </a>
</div>
...
New migrations use Prisma's standard `migration.sql` layout and `_prisma_migrations` table. Rollbacks live in a separate `down.sql` file, which Prisma ignores during forward deploys.
...
- **SQL migrations** - Forward and rollback SQL in separate files
