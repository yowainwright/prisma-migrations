...
- **No programmatic control**: Can't write migrations in TypeScript/JavaScript with type safety
...
- **SQL migration support**: Execute existing Prisma .sql migrations
...
- **AI assistant (MCP)**: 15 migration tools for Claude Desktop and other AI assistants
